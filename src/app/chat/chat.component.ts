...
export class ChatComponent implements OnInit, AfterViewInit {
  ...
  private initIoConnection(): void {
    ...
    this.socketService.onDraw().subscribe((message: any) => {
      this.drawOnCanvas(message.prevPos, message.currentPos);
    });

    this.socketService.onStrokeStyle().subscribe((data: any) => {
      this.cx.strokeStyle = data.strokeStyle;
      this.cx.lineWidth = data.lineWidth;
    });
    this.socketService.onCanvasClear().subscribe((data: any) => {
      this.clearAll();
    });
  }
